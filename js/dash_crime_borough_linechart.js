...
export function drawCrimeChart({
    ...
    function initializeCrimeChart() {
        ...
        boroughLines = linesGroup.selectAll(".crime-line").data([]);
        positionAxisLabels()
    }
    ...
    function redrawLines() {
        ...
        boroughLines = linesGroup.selectAll(".crime-line")
            .data(boroughs, d => d[0])
            .join(
        ...
        t.tween("yDomain", () => {
            return function (tVal) {
                ...
                linesGroup.selectAll(".crime-line")
                    .attr("d", d => lineGen(d[1]));
                redrawYAxis();
            };
        });
        ...
        t.on("end", () => {
            const lines = linesGroup.selectAll(".crime-line");
    ...
    function zoomIn(event) {
        ...
        brush.on("start", () => overlay.style("pointer-events", "all"));
        brush.on("end", () => overlay.style("pointer-events", "none"));
