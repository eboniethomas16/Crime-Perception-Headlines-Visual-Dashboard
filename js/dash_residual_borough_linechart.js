...
export function drawResidualChart({
    ...
    const linesGroup = chartGroup.append("g")
        ...
        .attr("clip-path", "url(#residual-borough-clip)");
    ...
    function initializeResidualChart() {
        ...
        aggregatedLine = chartGroup.append("path")
        ...
        boroughLines = linesGroup.selectAll(".residual-line")
            .data([])
    ...
    function redrawLines() {
        ...
        t.tween("yDomain", () => {
            return function (tVal) {
                ...
                linesGroup.selectAll(".residual-line").attr("d", d => lineGen(d[1]));
                aggregatedLine.attr("d", lineGen(aggregatedResiduals));
                yAxis.call(d3.axisLeft(y));
    ...
    function updateActiveBoroughs(activeSet) {
        ...
        if (!activeSet || activeSet.size === 0) {
            linesGroup.selectAll(".residual-line").remove();
            boroughLines = linesGroup.selectAll(".residual-line").data([]);
            aggregatedLine
