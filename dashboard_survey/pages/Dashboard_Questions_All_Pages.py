...
def page_preliminary():
    ...
    q1 = st.text_input("How safe do you feel in your neighbourhood?")
    q2 = st.slider("How often do you read crime news?", 0, 10)

    if st.button("Next"):
        st.session_state.answers["pre_q1"] = q1
        st.session_state.answers["pre_q2"] = q2
